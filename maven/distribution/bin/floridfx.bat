...
@rem ##########################################################################
@rem
@rem  floridfx startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute floridfx
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" com.myteer.floridfx.Launcher %CMD_LINE_ARGS%
